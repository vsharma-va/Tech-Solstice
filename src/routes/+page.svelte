...
<div class="h-fit w-full absolute top-0 basic-scroll-animation">
    ...
    <div class="h-[40vh] w-full sticky top-0 bg-surface z-[2]">
        ...
        <div class="h-full w-full flex flex-col items-start justify-between p-5">
            <p class="brand-font text-[14vw] leading-9 text-on-surface text-start">©2024</p>
            <p class="brand-font text-[50vw] leading-8 text-on-surface text-start">SOLSTICE</p>
        </div>
    </div>
</div>
