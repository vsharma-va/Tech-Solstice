<script>
    ...
    import jrnySponsor from "$lib/assets/images/jrny_sponsor.webp";
    import mboscSponsor from "$lib/assets/images/mbosc_sponsor.svg";
    import sbiSponsor from "$lib/assets/images/SBILogo.webp";
    import schneiderSponsor from "$lib/assets/images/SchneiderElectricLogo.webp";
    import signitudeSponsor from "$lib/assets/images/SigniTudeLogo.webp";
    ...
    onMount(() => {
        ...
        const observer = new IntersectionObserver((logos) => {
            logos.forEach((logo)=> {
                if(logo.isIntersecting) {
                    logo.target.classList.add("show");
                } else {
                    logo.target.classList.remove("show");
                }
            });
        });

        const logoElems = document.querySelectorAll(".hiddenNormal");
        logoElems.forEach((logoElem) => observer.observe(logoElem));
...
<div class="h-fit w-full absolute top-0 basic-scroll-animation">
    <div class="h-screen w-full sticky top-0 first-division-container">
        <div class="h-full w-full z-2 grid grid-cols-3 absolute top-0 overflow-hidden">
            ...
            <!--            <div class="h-[140%] w-full bg-transparent hidden absolute top-0 left-1/2 -translate-x-1/2 spotlight spot-left rotate-[20deg]"></div>-->
    ...
    <div class="h-[600vh] w-full sticky top-0 bg-surface call-to-action-trigger z-[2]">
        ...
        <div class="h-screen w-full sticky top-0 flex flex-col items-center justify-center show">
    ...
    <div class="h-[200vh] w-full bg-on-surface sticky top-0 z-[4] faq-trigger">
        <div class="h-screen w-full absolute -top-[48px] items-center justify-center overflow-hidden">
            <svg width="1920" height="48" viewBox="0 0 1920 48" fill="none" class="fill-on-surface"
                 xmlns="http://www.w3.org/2000/svg">
                <path d="M944.931 4.96811L948.426 8.47002L951.934 4.96811H944.931ZM1193.34 13.0261H1187.65L1187.68 13.0504H1193.31L1193.34 13.0261ZM1586.65 12.8323L1580.12 6.27678H1569.09L1555.46 20.5752L1555.44 20.551V20.5752L1547.59 13.0504H1193.3L1190.48 15.8737L1195.19 20.5752H1185.79L1190.48 15.8737L1187.66 13.0504H1117.91L1113.91 9.02741L1106.01 1.11479L1100.75 6.38584L1074.08 6.26466H1069.8L1059 17.0854H1030.29L1024.1 10.8935L960.715 10.9298L955.792 15.8616L948.414 8.4579L945.947 10.9298L804.968 10.8935L794.083 0L773.558 20.5631L765.829 12.8201H762.551L760.761 14.6135L763.604 17.4611H757.919L760.749 14.6135L758.995 12.8565L701.012 12.8201V48H1920V12.8201H1586.69L1586.65 12.8323ZM1074 14.9891H1072.52V13.5108H1074V14.9891ZM1074 12.0204H1072.52V10.5421H1074V12.0204ZM1085.46 14.9891H1083.99V10.5421H1085.46V14.9891ZM1091.13 12.0204H1089.66V10.5421H1091.13V12.0204ZM1501.22 20.5631H1496.78V16.1161H1501.22V20.5631ZM1516.01 20.5631H1514.53V16.1161H1516.01V20.5631ZM1526.36 20.5631H1524.89V16.1161H1526.36V20.5631ZM1528.6 20.5631H1527.12V16.1161H1528.6V20.5631Z"
        ...
        <div class="min-h-screen h-fit w-full flex sticky top-0 flex-col items-center justify-center p-5 mb-0 sm:mb-6">
            <section class="p-0 sm:p-8">
                <div class="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
                    <p class="w-full h-full text-center text-[6rem] font-bold tracking-wide brand-font text-on-primary leading-[1.1]">PREMIUM SPONSORS</p>
                    <div class="w-full h-fit flex flex-wrap justify-center items-center text-gray-500 dark:text-gray-400 gap-y-0">
                        <div class="flex flex-col items-center lg:justify-center px-4 hiddenNormal" >
                            <img class="w-[13rem] sm:w-[30rem] h-[13rem] sm:h-[20rem] object-contain" src="{jrnySponsor}" alt="">
                        </div>
                        
                        <div class="flex flex-col justify-center items-center lg:justify-center px-4 hiddenNormal !delay-200 sm:!delay-[400ms]">
                            <img class="w-[13rem] sm:w-[30rem] h-[13rem] sm:h-[20rem] object-contain" src="{signitudeSponsor}" alt="">
                        </div>
                        <div class="flex flex-col justify-center items-center lg:justify-center px-4 hiddenNormal !delay-300 sm:!delay-0">
                            <img class="w-[13rem] sm:w-[30rem] h-[13rem] sm:h-[20rem] object-contain" src="{sbiSponsor}" alt="">
                        </div>
                        <div class="flex flex-col justify-center items-center lg:justify-center px-4 hiddenNormal !delay-[400ms] sm:!delay-200">
                            <img class="w-[13rem] sm:w-[30rem] h-[13rem] sm:h-[20rem] object-contain" src="{schneiderSponsor}" alt="">
                        </div>
                        <div class="flex flex-col justify-center items-center lg:justify-center px-4 hiddenNormal !delay-100 sm:!delay-200">
                            <img class="w-[13rem] sm:w-[30rem] h-[13rem] sm:h-[20rem] object-fit" src="{mboscSponsor}" alt="">
                        </div>
                    </div>
                </div>
            </section>
